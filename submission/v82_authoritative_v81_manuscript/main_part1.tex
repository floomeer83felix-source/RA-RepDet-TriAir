% V82 authoritative checkpoint-backed V81 single-modality manuscript.
...
\begin{itemize}
    ...
    \item We report a fresh checkpoint-backed three-seed replication of RGB-only, thermal-only, and event-only baselines with standardized COCO AP, AP50, AP75, AR1, AR10, and AR100, together with deterministic channel-removal and efficiency analyses.
