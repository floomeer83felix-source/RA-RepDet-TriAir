...
\tabref{tab:mmuav-transfer} reports the frozen three-seed summary. Supervised alignment-aware training raises AP from effectively zero under frozen naive-grid transfer to $0.2234\pm0.0073$ for Scratch Equal. TriAir Init Equal reaches $0.2178\pm0.0020$, and TriAir Init Reliability reaches $0.2151\pm0.0090$. The corresponding AP50 means are 0.5569, 0.5526, and 0.5451; AR100 means are 0.3513, 0.3437, and 0.3422. Thus, the target-domain alignment and supervision recover useful detection performance, but neither TriAir initialization nor reliability-aware fusion improves the three-seed mean over the matched from-scratch control under this fixed schedule.

\begin{table*}[t]
\centering
\caption{Frozen three-seed MM-UAV supervised transfer summary. AP is mean $\pm$ sample standard deviation; remaining values are three-seed means. Comparisons are descriptive and use an exposed devval split.}
...
\midrule
Frozen TriAir, naive-grid zero-shot & 0.000 & 0.000 & 0.000 & 0.000 & Direct unregistered transfer failed\\
\textbf{MM-UAV Scratch Equal} & $\mathbf{0.2234\pm0.0073}$ & \textbf{0.5569} & \textbf{0.1340} & \textbf{0.3513} & Highest supervised mean under fixed protocol\\
TriAir Init Equal & $0.2178\pm0.0020$ & 0.5526 & 0.1254 & 0.3437 & No positive mean transfer benefit\\
TriAir Init Reliability & $0.2151\pm0.0090$ & 0.5451 & 0.1254 & 0.3422 & No additional mean reliability-fusion benefit\\
\bottomrule
\end{tabularx}
\end{table*}
