...
INPUTS = {
    ...
    "blank_author_review_template_copy": "reproducibility/v40_expanded_adjacency_component_split_v1/source_lock/filename_proximity_author_review_blank_template_before_v40_confirmation.csv",
    ...
    for mixed_count in sorted(candidate_counts):
        ...
        for correction_moved, correction_gt, _correction_bits, selected_corrections in correction_options:
            ...
            for mixed_gt, mixed_bits in mixed_gt_bits.items():
                ...
                final_val_gt = pure_val_base_gt + mixed_gt + correction_gt
...
def main() -> int:
    ...
    script_paths = [
        ...
        script_dir / "build_v40_expanded_adjacency_split.py",
        script_dir / "audit_v40_expanded_adjacency_split.py",
    ]
