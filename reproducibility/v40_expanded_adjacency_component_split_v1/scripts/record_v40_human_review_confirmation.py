...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--blank-template-copy",
        default="reproducibility/v40_expanded_adjacency_component_split_v1/source_lock/filename_proximity_author_review_blank_template_before_v40_confirmation.csv",
